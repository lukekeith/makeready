...
import { getChapterVerses } from '../services/bible-chapter.js'
...
// Chapter-first caching moved to services/bible-chapter.ts so semantic
// search can reuse it for translation text resolution.
