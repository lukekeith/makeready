...
@section('content')
<div class="TermsPage">
    <div class="TermsPage__container">
        <div class="TermsPage__content">
            <h1 class="TermsPage__title">Terms of Service</h1>
            <p class="TermsPage__updated">Last updated: February 4, 2026</p>

            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">1. Acceptance of Terms</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">2. Eligibility</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">3. Description of Service</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">4. Account Registration and Security</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">5. SMS Messaging Terms</h2>
                <p class="TermsPage__text">
                    By opting in to SMS notifications during the join process, you agree to the
                    following:
                </p>
                <ul class="TermsPage__list">
                    <li>
                    ...
                    <li>
                        ...
                        at
                        <a href="mailto:support@makeready.org" class="TermsPage__link">support@makeready.org</a>.
                    </li>
                </ul>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">6. User Responsibilities</h2>
                <p class="TermsPage__text">You agree to:</p>
                <ul class="TermsPage__list">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">7. Acceptable Use Policy</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">8. User-Generated Content</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">9. Intellectual Property</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">10. Account Termination</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">11. Disclaimer of Warranties</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">12. Limitation of Liability</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">13. Indemnification</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">14. Dispute Resolution</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">15. Governing Law</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">16. Changes to Terms</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">17. Severability</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">18. Entire Agreement</h2>
                <p class="TermsPage__text">
            ...
            <section class="TermsPage__section">
                <h2 class="TermsPage__heading">19. Contact</h2>
                <p class="TermsPage__text">
