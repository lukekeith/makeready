...
private let api: APIClientProtocol
    ...
    // The four highlight operations for the enrollment (scheduled-activity) context. Each one is a
    ...
    // program twins were eight near-identical hand-written methods, and every
    ...
    private var highlightStore: APIHighlightStore {
        APIHighlightStore(context: .enrollment, api: api)
    }
